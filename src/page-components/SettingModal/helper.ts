...
import { CaHolderBingoInfoDto } from '@/services/graphql/types';
import { decodeAmount } from '@/utils/common';
import { TOKEN_UNIT } from '@/constants/global';
import BigNumber from 'bignumber.js';

export const groupBetsByDate = (newBetList: CaHolderBingoInfoDto[], oldBetList: BetListType): BetListType => {
